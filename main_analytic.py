...
from service.generate_vector.compute_similarity import get_similarity, get_name
'''
fastapi기반 google auth 구현을 위하여 잠시 분리함
복사 코드
'''

if __name__ == "__main__":
    spotify_object = SpotifyAuthManage()
    search_results = spotify_object.search_track("뉴진스 하입보이", limit=1)
    ...
    '''
    예시 출력
    {'kind': 'youtube#searchListResponse', 'etag': 'GwAie_nABZiBlPkpabH_jgHLvtI', 'nextPageToken': 'CAEQAA', 'regionCode': 'KR', 'pageInfo': {'totalResults': 866554, 'resultsPerPage': 1}, 'items': [{'kind': 'youtube#searchResult', 'etag': 'PQqpiuNTddbEWGzED0Mr8oTDczc', 'id': {'kind': 'youtube#video', 'videoId': '11cta61wi0g'}, 'snippet': {'publishedAt': '2022-08-18T09:00:01Z', 'channelId': 'UC3IZKseVpdzPSBaWxBxundA', 'title': 'NewJeans (뉴진스) &#39;Hype Boy&#39; Official MV (Performance ver.1)', 'description': "NewJeans (뉴진스) 'Hype Boy' Official MV (Performance ver.1) Producer: MIN HEE JIN Music Video Director: Dongle Shin ...", 'thumbnails': {'default': {'url': 'https://i.ytimg.com/vi/11cta61wi0g/default.jpg', 'width': 120, 'height': 90}, 'medium': {'url': 'https://i.ytimg.com/vi/11cta61wi0g/mqdefault.jpg', 'width': 320, 'height': 180}, 'high': {'url': 'https://i.ytimg.com/vi/11cta61wi0g/hqdefault.jpg', 'width': 480, 'height': 360}}, 'channelTitle': 'HYBE LABELS', 'liveBroadcastContent': 'none', 'publishTime': '2022-08-18T09:00:01Z'}}]}
    '''